...
[internal and undocumented API](https://github.com/Revadike/InternalSteamWebAPI).
...
official Web API and the internal API of Steam. Many functions operate around
a so-called application ID or `appid`. One way to find the app ID for a game
is to search for it programmatically:
